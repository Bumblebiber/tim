...
exports.formatResumeList = formatResumeList;
exports.formatResumePayload = formatResumePayload;
function formatResumeList(projectLabel, list) {
    if (list.length === 0) {
...
function formatResumePayload(p) {
    ...
    const batchSection = p.batchSummaries.length
        ? [
            ...
            ...p.batchSummaries.map(b => `### Batch ${b.batchIndex} (seq ${b.seqFrom}–${b.seqTo})\n${b.text.trim()}`),
        ].join('\n\n')
        : '## Batch Summaries\n(none)';
