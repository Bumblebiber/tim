...
exports.migrateRetireStructuralTags = exports.migrateTagsToTypes = exports.createV2HmemDatabase = exports.inspectHmemManifest = exports.inspectHmemFile = exports.detectHmemFormat = exports.repairProjectKind = exports.repairImportFlags = exports.labelFromMetadata = exports.tim_import = exports.exportToMarkdown = exports.exportToHmem = exports.tim_export = void 0;
...
var retire_structural_tags_js_1 = require("./retire-structural-tags.js");
Object.defineProperty(exports, "migrateRetireStructuralTags", { enumerable: true, get: function () { return retire_structural_tags_js_1.migrateRetireStructuralTags; } });
