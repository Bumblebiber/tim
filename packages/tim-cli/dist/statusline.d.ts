...
export declare function reconcileMarkerCounters(store: TimStore, marker: ProjectMarkerInput): Promise<ProjectMarker>;
...
export declare function formatTimStatusLine(marker: ProjectMarkerInput, projectName?: string): string;
