...
export type ResolveSectionResult =
  | { status: 'found'; id: string; project: string; title: string }
  | { status: 'not_found'; project: string; title: string; candidates: string[] }
  | { status: 'ambiguous'; project: string; title: string; candidates: SectionCandidate[] };
