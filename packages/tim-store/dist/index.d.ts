...
export { SessionManager, resolveCurrentSession, isAutomatedSession, ensureProjectForPath, type Exchange, type ExchangeRole, type SessionStartParams, type ProjectSessionParams, type Summarizer, type UnsummarizedBatch, type UnsummarizedExchange, type UntaggedBatch, type BatchFullInfo, type OnBatchFullHandler, type EnsureProjectForPathResult, type ResumeBatchSummary, type ResumeExchange, type ResumePayload, type ResumeSessionOpts, type ResumableSession, } from './session.js';
